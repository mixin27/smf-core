...
class _$_Api with DiagnosticableTreeMixin implements _Api {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'VimeoFailure.api'))
...
class _$_Unknown with DiagnosticableTreeMixin implements _Unknown {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'VimeoFailure.unknown'))
      ..add(DiagnosticsProperty('message', message));
  }
